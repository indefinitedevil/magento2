...
/**
 * Class AddNonBinaryGenderAttributeOption
 * @package Magento\Customer\Setup\Patch
 */
class AddNonBinaryGenderAttributeOption implements DataPatchInterface, PatchVersionInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $option = ['attribute_id' => $attributeId, 'values' => [4 => 'Non-Binary']];
